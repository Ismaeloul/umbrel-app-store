...
// Rescatado en la poda (fase 0.2, b-arquitectura §1.11) de `PairingViewModel`
// (Features/Pairing/PairingViewModel.swift), sin cambiar el comportamiento. M7 le añade los estados
// de cámara, el canje automático y la pausa de 60 s (§1.12).

/// Pantalla de emparejamiento: direcciones del servidor y código de 6 dígitos
/// (tecleado o leído del QR `aceneo://pair?u=…&c=…`).
@MainActor
@Observable
final class ModeloEmparejar {
