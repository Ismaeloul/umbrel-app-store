...
import type { StateDeps, StateService } from './types.js';

export type * from './types.js';

export function createStateService(_deps: StateDeps): StateService {
  return notImplementedService<StateService>('state');
}
