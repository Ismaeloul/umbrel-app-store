/* Exportaciones de server.js (0.6.59) que corresponden al módulo
   `events`, con los mismos nombres (comportamientos-tests.md §3.1-3.2).
   ...
   Módulo nuevo en la 0.7.0: server.js no tenía tiempo real (los clientes
   sondeaban /api/playback cada 5 s). */
