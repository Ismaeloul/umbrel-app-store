/* Fábrica del módulo `health` (salud y versión).
...
import type { HealthDeps, HealthService } from './types.js';

export type * from './types.js';

export function createHealthService(_deps: HealthDeps): HealthService {
  return notImplementedService<HealthService>('health');
}
