/* Fábrica del módulo `search` (buscador del motor AceStream).
...
export function createSearchService(_deps: SearchDeps): SearchService {
  return notImplementedService<SearchService>('search');
}
