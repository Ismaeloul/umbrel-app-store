/* Fábrica del módulo `directories` (directorios M3U/HTML/IPFS y su sincronización).
...
import type { DirectoriesDeps, DirectoriesService } from './types.js';

export type * from './types.js';

export function createDirectoriesService(_deps: DirectoriesDeps): DirectoriesService {
  return notImplementedService<DirectoriesService>('directories');
}
