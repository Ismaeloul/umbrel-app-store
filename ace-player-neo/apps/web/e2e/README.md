...
| Multi | `multidispositivo.spec.ts` | Dos dispositivos (docs/multidispositivo.md §6.3): «¿Cambiar en los dos o solo aquí?», seguir al otro, el aviso «Ahora en el PC» con «Ver … aquí» y «Volver a …», cancelar, la cápsula (axe y teclado), un solo dispositivo, el interruptor, cliente viejo, zapping recordado, cambios a la vez, hoja abierta con traspaso, otra pestaña y capturas en `test-results/capturas-multi/`. |
