...
/* ---------- EPG de Movistar+ : fuente principal de la agenda ----------
...
async function getFootballSchedule() {
  ...
  // EPG primero; TheSportsDB queda de red de seguridad porque el endpoint de
  // Movistar no es una API con contrato y puede cambiar sin avisar
  footballCache.pending = fetchEpgFootballSchedule()
