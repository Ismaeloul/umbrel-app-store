...
function channelMatchScore(left, right) {
  ...
  /* Familia: un lado es el otro mas un numero de canal. Si lo que sobra es una
     PALABRA -"Hypermotion"- no es familia sino otra competicion, y se queda
     topado en 58 como hasta ahora. */
  ...
  if ((a.includes(b) || b.includes(a))
      && (soloSobranNumeros(tokensA, tokensB) || soloSobranNumeros(tokensB, tokensA))) {
    return CHANNEL_FAMILY_SCORE;
  }
